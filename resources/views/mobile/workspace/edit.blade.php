        ...
        <form action="{{ route('agent.workspace.update', [$workspace->id]) }}" method="POST">
            ...
            <div class="bg-white rounded-top-3 p-3 pb-0" style="z-index: 99">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control form-control-lg fs-3" placeholder="Nama Workspace" id="name" name="name" value="{{ old('name', $workspace->name) }}" required>
                </div>
                <div class="mb-2">
                    <label for="description" class="fs-3 text-muted form-label">Deskripsi / Keterangan</label>
                    <textarea class="form-control form-control-lg fs-3" rows="4" cols="10" placeholder="Keterangan" id="description" name="description">{{ old('description', $workspace->description) }}</textarea>
                </div>
                <div class="mb-2">
                ...
                <div class="mb-1 d-flex align-items-center gap-2">
                    ...
                    <textarea class="form-control form-control-lg fs-3 bg-white" rows="2" cols="10" placeholder="Alamat Lengkap" id="address" name="address">{{ old('address', $workspace->address) }}</textarea>
                </div>
                ...
                <div class="mb-1 d-flex align-items-center gap-2">
                    ...
                    <input type="text" class="form-control form-control-lg fs-3 bg-white" placeholder="Nama PIC" id="pic_name" name="pic_name" value="{{old('pic_name', $workspace->pic_name)}}" required>
                </div>
                <div class="mb-1 d-flex align-items-center gap-2">
                    <i class="ti ti-phone fs-4 text-dark"></i>
                    <input type="number" class="form-control form-control-lg fs-3 bg-white" placeholder="Phone" id="pic_phone" name="pic_phone" value="{{old('pic_phone', $workspace->pic_phone)}}" required>
                </div>
                <div class="mb-1 d-flex align-items-center gap-2">
                    <i class="ti ti-mail fs-4 text-dark"></i>
                    <input type="email" class="form-control form-control-lg fs-3 bg-white" placeholder="Email" id="pic_email" name="pic_email" value="{{old('pic_email', $workspace->pic_email)}}">
                </div>
                
                <div class="fs-3 text-muted form-label mt-2">Total Jamaah</div>
                <div class="mb-1 d-flex align-items-center gap-2">
                    <i class="ti ti-gender-male fs-4 text-dark"></i>
                    <input type="number" class="form-control form-control-lg fs-3 bg-white" placeholder="Total Jamaah Laki Laki" id="total_pilgrim_male" name="total_pilgrim_male" value="{{old('total_pilgrim_male', $workspace->total_pilgrim_male)}}">
                </div>
                <div class="mb-1 d-flex align-items-center gap-2">
                    <i class="ti ti-gender-female fs-4 text-dark"></i>
                    <input type="number" class="form-control form-control-lg fs-3 bg-white" placeholder="Total Jamaah Perempuan" id="total_pilgrim_female" name="total_pilgrim_female" value="{{old('total_pilgrim_female', $workspace->total_pilgrim_female)}}">
                </div>
