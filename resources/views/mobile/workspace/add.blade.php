            ...
            <div class="bg-white rounded-top-3 p-3 pb-0" style="z-index: 99">
                ...
                <div class="mb-1 d-flex align-items-center gap-2">
                    ...
                    <input type="number"
                        ...
                        placeholder="Total Jamaah Laki Laki"
                        id="total_pilgrim_male"
                        name="total_pilgrim_male"
                        value="{{ old('total_pilgrim_male') }}"
                        max="999"
                ...
                <div class="mb-1 d-flex align-items-center gap-2">
                    ...
                    <input type="number"
                        class="form-control form-control-lg fs-3 bg-white"
                        placeholder="Total Jamaah Perempuan"
                        id="total_pilgrim_female"
                        name="total_pilgrim_female"
                        value="{{ old('total_pilgrim_female') }}"
                        max="999"
                        oninput="this.value = this.value.slice(0, 3);">
