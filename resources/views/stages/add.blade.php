    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Add New Stage</h4>
            ...
            <div class="col-md-8 mb-2">
                <div class="card">
                    <div class="px-4 py-3 border-bottom">
                        <h5 class="card-title fw-semibold mb-0">Add Stage</h5>
                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control ps-2"
                                            placeholder="Nama Stage" value="{{old('name')}}" required>
                                    </div>
                                    @error('name')
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="order" class="form-control ps-2"
                                            placeholder="Urutan Stage" value="{{old('order')}}">
                                    </div>
                                    @error('order')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="deadline_days" class="form-control ps-2" min="1"
                                        placeholder="" value="{{old('deadline_days')}}" required>
                                </div>
                                <div class="">Hari</div>
                            </div>
                            <div class="fs-2 mt-2 text-muted">Contoh : 30 hari, maka deadline merupakan h+30 dari waktu penyetujuan item kerja WPS</div>
                            @error('deadline_days')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
