...
class TanurController
{
   ...
   public function notify($id_agent, $email = 1, $whatsapp = 1, $pushnotification = 1, $subject, $message, $forAgent = null, $datatype = "wps", $datapayload = null)
   {
      $av_types = ['wps', 'wps_approval', 'wps_workspace'];
      $response = Http::asForm()->post("{$this->baseUrl}/support/notification/send", [
         ...
         'subject' => $subject,
         'message' => $message,
         'datatype' => in_array($datatype, $av_types) ? $datatype : "wps",
         'datapayload' => $datapayload ? json_encode($datapayload) : null,
